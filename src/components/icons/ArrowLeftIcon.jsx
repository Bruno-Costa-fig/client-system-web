...
function ArrowLeftIcon({ className, size = 16, handleClick, color = '#333333', ...props }) {
  return (
    <svg {...props} className={`cursor-pointer ${className}`} onClick={() => handleClick()} width={size} height={size} viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
