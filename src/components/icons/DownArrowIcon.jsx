...
function DownArrowIcon({ className, handleclick = null, size = 16, color = "#E64B4B" }) {
  return (
    <button className={`cursor-pointer ${className}`} onClick={() => handleclick()} type='button'>
      <svg width={size} height={Number.parseInt(size) + 1} viewBox="0 0 16 17" fill="none" xmlns="http://www.w3.org/2000/svg">
